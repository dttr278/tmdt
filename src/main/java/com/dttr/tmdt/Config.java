...
public class Config {
    ...
    public static String vnp_TmnCode = "AOEJUJ1T";
    public static String vnp_HashSecret = "SZJCJIGMFKGYFKERRFONTODELBVXBRPH";
    ...
    public static String hashAllFields(Map fields) {
        ...
        sb.append(com.dttr.tmdt.Config.vnp_HashSecret);
